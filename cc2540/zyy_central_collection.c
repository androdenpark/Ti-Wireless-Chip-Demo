...
static uint16 simpleBLEConnHandle = GAP_CONNHANDLE_INIT;	//GAP_CONN_HANDLE_DEFINES GAP Special Connection Handles Used by GAP_TerminateLinkReq(): terminates a link create
